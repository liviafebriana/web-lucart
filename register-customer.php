...
if (isset($_POST['submit'])) { // untuk create
    ...
    if (mysqli_num_rows($cek_email) > 0) {
        ...
        $role = 'customer';
        $insert = mysqli_query($koneksi, "insert into user (email, username, password, role) values ('$email', '$username', '$password', '$role')");

        if ($insert) {
            $_SESSION['pesan'] = "Selamat anda berhasil Registrasi! silahkan Login.";
            $_SESSION['alert_type'] = "success";
            $_SESSION['redirect'] = "login.php";
        } else {
            $_SESSION['pesan'] = "Coba lagi, registrasi anda gagal.";
            $_SESSION['alert_type'] = "warn";
        }
    }
}
...
<head>
    ...
    <title>Lucart | Registration</title>
        ...
        <div class="register-box">
            <div class="card card-outline card-primary" style="background-color: rgba(248, 245, 245); border-top-color: #776B5D;">
                <div class="card-header text-center">
                    <a href="register.php" class="h1"><b>Member</b>Lucart</a>
                    <style>
                        a:hover {
                            color: #776B5D;
                        }
                ...
                <div class="card-body">
                    ...
                    <a href="login.php" class="text-center" style="color: #776B5D;">I already have a membership</a>
                </div>
                <!-- /.form-box -->
            </div><!-- /.card -->
        </div>
